...
int main(){
	...
	for (int i=0; i < num_parallel;i++){
		...
		if (i<10) {
			...
			act_threshold = 2*i + 6; // Activation threshold for excitatory vertices			
		}
		else{
			pattern_size = 142; // Size of a pattern
			act_threshold = 2*(i-10)+6; // Activation threshold for excitatory vertices						
		}
		...
		if (i==7) {
			...
			//	}
				...
				int final_number_patterns_stored = 2*(number_vertices/pattern_size)*(number_vertices/pattern_size)/number_associations;
