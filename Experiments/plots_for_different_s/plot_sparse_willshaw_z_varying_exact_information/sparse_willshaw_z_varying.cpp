...
//End Search for right density %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	for (int i = 0; i < number_trials_new_graph; i++) {
		...
		//vector<int> vector_inside_activity(num_patterns_down*number_associations);
		//vector<int> vector_outside_activity(num_patterns_down*number_associations);
	...
	for( int i=0; i< number_trials_new_graph; i++){
		...
		/* if(i==0){
		 ...
		 if(i==0){
			file_percolation << "inside_activity=zeros("
				<< final_number_patterns_stored  <<"," << number_trials_new_graph << "); \n" ;
		}
		 if(i==0){
			file_percolation << "outside_activity=zeros("
				<< final_number_patterns_stored  <<"," << number_trials_new_graph << "); \n" ;
		}
		...
		file_percolation << "\n";
		for (int j = 0; j < final_number_patterns_stored*number_associations; j++) {
			file_percolation << "inside_activity(" << j+1 << "," << i+1 << ") = " << vector_inside_activity[i][j] << ";";
			file_percolation << "outside_activity(" << j+1 << "," << i+1 << ") = " << vector_outside_activity[i][j] << ";";
		}
		file_percolation << "\n";
	}
}
